...
func (n *netConn) writeString(framer Framer, formatter Formatter, p Priority, hostname, tag, msg string, appName string) error {
	if framer == nil {
	...
	formattedMessage := framer(formatter(p, hostname, tag, msg, appName))
